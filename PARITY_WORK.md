...
- [ ] Workspace commands: named inspector/timeline dimension presets now have save, update, apply, delete and reset controls in Preferences, with local persistence. Browser save/reset/apply/delete and layout display have been verified; remaining view/workspace commands are still pending.
