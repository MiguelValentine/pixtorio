...
import {
  ...
  canvasLocalPoint,
  clipDirtyBounds,
  findCanvasContextTarget,
  hitPoint,
  hitTransformHandle,
  resizedTransformBounds,
  rotationHandle,
  samePoint,
  segmentTouchesDocument,
  simplifyPolygonDrag,
  transformCenter,
  transformCursors,
  transformHandleSize,
...
import type {CanvasContextTarget} from "./canvasGeometry";
...
export type {CanvasContextTarget} from "./canvasGeometry";
